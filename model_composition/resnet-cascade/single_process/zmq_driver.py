...
def get_heavy_node_configs(num_replicas, batch_size, allocated_cpus, allocated_gpus):
    res50_config = HeavyNodeConfig(model_name=RES50_MODEL_NAME,
                                   input_type="floats",
    ...
    res152_config = HeavyNodeConfig(model_name=RES152_MODEL_NAME,
                                    input_type="floats",
                                    num_replicas=num_replicas,
                                    allocated_cpus=allocated_cpus,
                                    gpus=allocated_gpus,
    ...
    alexnet_config = HeavyNodeConfig(model_name=ALEXNET_MODEL_NAME,
                                     input_type="floats",
                                     num_replicas=num_replicas,
                                     allocated_cpus=allocated_cpus,
                                     gpus=[],
    ...
    return [res50_config, res152_config, alexnet_config]
