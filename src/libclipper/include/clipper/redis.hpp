 ...
 */
bool delete_container(redox::Redox& redis, const ContainerId container_id);
...
get_container(redox::Redox& redis, const ContainerId container_id);
 ...
 */
std::pair<std::vector<ContainerModelDataItem>, std::unordered_map<std::string, std::string>>
get_container_by_key(redox::Redox& redis, const std::string& key);
