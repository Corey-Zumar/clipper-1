...
from ..container_manager import (
    ...
    CLIPPER_INTERNAL_QUERY_SEND_PORT, CLIPPER_INTERNAL_QUERY_RECV_PORT,
...
class DockerContainerManager(ContainerManager):
    def __init__(self,
                 ...
                 clipper_query_send_port=4455,
                 clipper_query_recv_port=4456,
        ...
        self.clipper_query_send_port = clipper_query_send_port
        self.clipper_query_recv_port = clipper_query_recv_port
    ...
    def start_clipper(self, query_frontend_image, mgmt_frontend_image,
        ...
        self.docker_client.containers.run(
            ...
            labels=mgmt_labels,
            **self.extra_container_kwargs)
        query_cmd = "--rpc_max_recv=10 --rpc_max_send=10 --redis_ip={redis_ip} --redis_port={redis_port} --prediction_cache_size={cache_size}".format(
        ...
        self.docker_client.containers.run(
            ...
            ports={
                ...
                '%s/tcp' % CLIPPER_INTERNAL_QUERY_RECV_PORT:
                self.clipper_query_recv_port,
